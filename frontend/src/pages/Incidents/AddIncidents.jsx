...
export default function AddIncidents() {
    ...
    const handleDeleteIncidentType = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://localhost:8000/accounts/incident-types/delete/${incidentToDelete.id}/`,
                {
                    method: "DELETE",
                    headers: {
    ...
    const handleCreateIncidentType = async () => {
        ...
        try {
            ...
            await fetch(
                "http://localhost:8000/accounts/incident-types/create/",
                {
                    method: "POST",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "http://localhost:8000/accounts/special-incidents/create/",
                {
                    method: "POST",
                    headers: {
                        "X-CSRFToken": getCookie("csrftoken"),
