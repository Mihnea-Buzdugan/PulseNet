...
export default function CreateCrisisEvents() {
    ...
    const fetchActiveEvents = useCallback(() => {
        ...
        fetch("https://pulsenet-45is.onrender.com/accounts/crisis-events/", {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("access_token")}`,
            },
        })
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch("https://pulsenet-45is.onrender.com/accounts/create-crisis-event/", {
                method: "POST",
                headers: {
    ...
    const confirmDeleteEvent = async () => {
        ...
        try {
            const response = await fetch(`https://pulsenet-45is.onrender.com/accounts/delete-crisis-event/${eventToDelete.id}/`, {
                method: "DELETE",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("access_token")}`,
                },
